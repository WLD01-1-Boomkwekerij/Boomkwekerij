<html>
    ...
    <body>
        ...
        $query = ('INSERT INTO boomkwekerij.gebruiker (Naam, Email, KrijgtEmail, Rol, Wachtwoord) VALUES (' . $data['gebr_naam'] . ',' . $data['gebr_mail'] . ',' . $data['krijgt_mail'] . ',' . $data['rol'] . ',' . $data['Wachtwoord1'] . ')');
        doSQL($query);
        ?>
    </body>
</html>